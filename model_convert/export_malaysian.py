...
def main():
    ...
    batch_size = 1
    self_k = torch.zeros(dims.n_text_layer, batch_size, dims.n_text_ctx, dims.n_text_state)
    self_v = torch.zeros(dims.n_text_layer, batch_size, dims.n_text_ctx, dims.n_text_state)
